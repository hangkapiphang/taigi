        ...
        c.innerHTML += `
            <div class="vocab-card ${active}" id="c-${i}">
                <div class="v-header">
                    ...
                    <!-- Time Adjustments: -1s, -0.1s, +0.1s, +1s -->
                    <button class="btn btn-teal btn-xs" onclick="adjustTime(${i}, -1.0)">-1s</button>
                    <button class="btn btn-teal btn-xs" onclick="adjustTime(${i}, -0.1)">-0.1s</button>
                    <button class="btn btn-teal btn-xs" onclick="adjustTime(${i}, 0.1)">+0.1s</button>
                    <button class="btn btn-teal btn-xs" onclick="adjustTime(${i}, 1.0)">+1s</button>
...
function fmtTime(s) { 
    // Substr(14, 9) captures MM:SS.mmm (e.g. "00:00.000")
    return new Date(s * 1000).toISOString().substr(14, 9); 
}
...
function adjustTime(i, amount) {
    ...
    if(t < 0) t = 0;
    // Fix floating point errors (e.g. 1.200000000002)
